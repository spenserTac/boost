...
class SponsorListingCreationModel(models.Model):
    ...
    overview_description = models.TextField(max_length=50000, default=None, null=True, blank=True)
    ...
    exp_description = models.TextField(max_length=50000, default=None, null=True, blank=True)
